...
REM
REM Generated by Vivado on Fri Aug 29 13:18:35 -0700 2025
...
echo "xvlog --incr --relax -prj testbench_pmod_ssd_vlog.prj"
call xvlog  --incr --relax -prj testbench_pmod_ssd_vlog.prj -log xvlog.log
